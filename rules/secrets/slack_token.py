"""
Rule to detect Slack Bot / Webhook Tokens.
"""
...
class SlackTokenRule(BaseRule):
    """
    Rule to detect exposed Slack API tokens (xoxb-, xoxp-, xapp-).
    """

    id = "secrets.slack_token"
    name = "Hardcoded Slack Token"
    description = "Detects hardcoded Slack bot or user access tokens."
