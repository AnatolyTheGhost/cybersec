"""
Rule to detect Stripe API Key leaks.
"""
...
class StripeKeyRule(BaseRule):
    """
    Rule to detect exposed Stripe secret and publishable keys (sk_live_, rk_live_).
    """

    id = "secrets.stripe_key"
    name = "Hardcoded Stripe Key"
    description = "Detects hardcoded Stripe live API secret keys."
