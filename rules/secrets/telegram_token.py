"""
Rule to detect Telegram Bot API Tokens.
"""
...
class TelegramTokenRule(BaseRule):
    """
    Rule to detect exposed Telegram Bot tokens.
    """

    id = "secrets.telegram_token"
